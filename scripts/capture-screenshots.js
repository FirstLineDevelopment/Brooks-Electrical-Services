...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <p>Inspect screenshots for engineering defects, Design Fidelity QA when a design source exists, and professional visual quality. Passing tests does not equal passing visual QA.</p>
    </header>
    <main>${contactItems}
    </main>
  </body>
...
- Design Fidelity QA: pass/fail/not applicable
- Visual QA: pass/fail
...
- UX Pilot source reviewed when applicable: yes/no
- UX Pilot deviations documented in docs/DESIGN_SOURCE.md: yes/no/not applicable
...
When a UX Pilot source exists, compare the approved design/reference against the implementation.

- Source export/reference:
- Viewports compared:
- Layout preserved: yes/no
- Section order preserved: yes/no
- Spacing and hero proportions preserved: yes/no
- Typography hierarchy preserved: yes/no
- Colors and visual rhythm preserved: yes/no
- Imagery roles preserved or intentionally replaced: yes/no
- Alignment, backgrounds, composition, and decorative treatment preserved: yes/no
- Material differences corrected:
- Material differences documented in docs/DESIGN_SOURCE.md:
...
- Design-source relationship: Design Fidelity QA asks whether the approved design was faithfully implemented; Visual QA asks whether the implemented site is polished across real devices
