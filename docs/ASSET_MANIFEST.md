...
| Service area image | public/assets/ServiceArea-clean.jpg | local aerial neighbourhood without map pins | Edited from UX Pilot generated export | Original: `design-source/uxpilot/BrooksElectrical - Home.html`; edit target: `public/assets/ServiceArea-pinned.png`; generated edit: `public/assets/ServiceArea-clean.png` | GENERATED CONCEPT | 1024x1024 | 1024x1024 | jpg | service-area cover | service area | USABLE SUPPORTING IMAGE | concept/demo approved | yes | yes | yes | Map pins removed with image edit; optimized JPEG used in site. |
